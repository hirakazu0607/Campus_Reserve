class ReservationsController < ApplicationController
  ...
  def new
    ...
    @reservation.facility_id = params[:facility_id] if params[:facility_id]
  end
  ...
  private
    ...
    def reservation_params
      params.expect(reservation: [ :facility_id, :user_name, :user_email, :start_time, :end_time, :purpose, :status ])
    end
end
